						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="Capacity" type="text" placeholder="Enter Capacity" v-model="powerStripToAdd.capacity"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Power Strip Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Outlets</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Outlets" type="text" placeholder="Enter Outlets" v-model="powerStripDetails.outlets"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Capacity</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Capacity" type="text" placeholder="Enter Capacity" v-model="powerStripDetails.capacity"></input>
																		</div>
						</td>
														</tr>
