...
<template>
  ...
  <base-input label="DateGenerated" type="text" placeholder="Enter DateGenerated" v-model="reportToAdd.dateGenerated"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'dateGenerated',
          visible: true,
          scopedSlots: { customRender: 'dateGenerated' },
          sorter: true
          //sorter: (a, b) => a.dateGenerated - b.dateGenerated,
          //sorter: (a, b) => a.dateGenerated.localeCompare(b.dateGenerated),
        },
      ],
      pagination: {
        current: 1,
